...
export const zhCN = {
  ...
  "app.composerEnterPlaceholder": "输入消息…",
  ...
  "app.composerShortcutPlaceholder": "输入消息…",
  ...
  "app.breakReminderTitleOne": "连续专注 1 小时，给眼睛放个假吧",
  "app.breakReminderTitleMany": "连续专注 {hours} 小时了，代码不会跑，但你会累的",
  "app.breakReminderBodyOne": "你已经和代码相处整整 1 小时。起身倒杯水、看看窗外、伸个懒腰——脖子和眼睛值得这 5 分钟。回来之后，灵感说不定已经悄悄上线。",
