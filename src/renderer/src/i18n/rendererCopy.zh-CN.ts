...
export const zhCN = {
  ...
  "app.breakReminderTitleOne": "是时候休息一下了，给眼睛放个假吧",
  "app.breakReminderTitleMany": "连续专注 {hours} 小时了，代码不会跑，但你会累的",
  "app.breakReminderBodyOne": "你已经和代码相处好一阵子了。起身倒杯水、看看窗外、伸个懒腰——脖子和眼睛值得这 5 分钟。回来之后，灵感说不定已经悄悄上线。",
  "app.breakReminderBodyMany": "不知不觉已经 {hours} 小时了。你的身体比任何代码都珍贵：站起来活动几分钟，深呼吸、放空大脑。休息不是偷懒，是给效率充电。",
  "app.breakReminderMuteSession": "本次启动不再提醒",
  "app.breakReminderDisableForever": "永久不再提醒",
  ...
  "config.skillHubInstallError": "安装 Skill 失败，请稍后重试",
  ...
  "config.process.type.main": "主进程",
  "config.process.type.renderer": "渲染进程",
  "config.process.type.gpu": "GPU",
  "config.process.type.utility": "工具进程",
  "config.process.type.zygote": "启动进程",
...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "usageStats.notInstalled.desc": "用量统计依赖 pi-tracker 扩展在 pi 进程内记录每次对话的 Token 消耗。安装后本页面自动开启。",
  "usageStats.notInstalled.installHint": "在终端执行：pi install npm:pi-tracker，然后重启 pi 会话",
  "usageStats.notInstalled.backfill": "安装前已有会话可在 pi 中执行 /analytics import 回填历史数据",
  ...
  "usageStats.projects.title": "项目用量",
  ...
  "settings.workBreakReminder": "连续使用时长提醒",
  "settings.workBreakReminderDesc": "从本次启动计时，连续使用每满 1 小时提醒起身休息",
  ...
  "settings.workspaceSplitOrientation": "分屏方向",
  "settings.workspaceSplitOrientationDesc": "与会话并排时的排列方式。",
  "settings.workspaceSplitOrientation.horizontal": "左右分屏",
  "settings.workspaceSplitOrientation.vertical": "上下分屏",
