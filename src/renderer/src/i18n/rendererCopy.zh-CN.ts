...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "settings.contentWidthPctDesc": "消息与输入框共用同一宽度，占聊天面板的百分比。数值越大内容越宽、留白越少；100% 为全宽。分屏或窗口较窄时自动减少留白。",
  "settings.contentWidthGap": "左右留白各 {pct}%",
  "settings.theme": "主题",
  ...
  "settings.expandInterimDuringStreamDesc": "关闭（默认）时，对话过程中思考与工具详情保持折叠，节省渲染资源；手动展开的轮次不受影响。开启时，最新轮流式输出时自动展开。",
