...
export const zhCN = {
  "app.chatProject": "聊天",
  "delegation.unavailable": "委托功能在预览模式不可用",
  "delegation.title": "委托任务",
  "delegation.task": "任务",
  "delegation.taskPlaceholder": "描述要交给子会话完成的任务",
  "delegation.role": "角色",
  "delegation.model": "目标模型",
  "delegation.thinking": "思考/努力程度",
  "delegation.defaultThinking": "不覆盖（使用默认）",
  "delegation.defaultModel": "使用父会话模型",
  "delegation.modelsLoading": "正在加载模型…",
  "delegation.modelsEmpty": "暂无可用模型",
  "delegation.taskDeliveryFailed": "子会话已创建，但任务尚未送达",
  "delegation.contextFresh": "Fresh context（全新上下文）",
  "delegation.workspaceShared": "Shared workspace（共享工作区）",
  "delegation.context": "上下文模式",
  "delegation.contextFreshOption": "Fresh（全新上下文）",
  "delegation.contextSelectedOption": "Selected（选择消息）",
  "delegation.contextForkOption": "Fork（Pi 原生分叉）",
  "delegation.contextForkDescription": "Fork 模式复用 Pi 原生 clone，保留 parent 历史，并把任务作为 child 的下一条消息。",
  "delegation.selectedContextCount": "已选上下文消息：{count}",
  "delegation.selectedContextLimit": "最多选择 {count} 条 user/assistant 消息",
  "delegation.selectedContextRequired": "Selected 模式至少选择一条消息",
  "delegation.selectContext": "选择消息",
  "delegation.selectContextTitle": "选择上下文消息",
  "delegation.selectContextConfirm": "使用选中消息",
  "delegation.constraints": "约束",
  "delegation.acceptanceCriteria": "验收标准",
  "delegation.relevantFiles": "相关文件（可选）",
  "delegation.relevantFilesPlaceholder": "列出需要关注的文件路径",
  "delegation.workspace": "工作区模式",
  "delegation.workspaceSharedOption": "Shared（共享工作区）",
  "delegation.workspaceWorktreeOption": "Worktree（隔离工作区）",
  "delegation.worktreeChecking": "正在检查 Git 工作区能力…",
  "delegation.worktreeUnavailable": "当前项目不可用 Git worktree，已回退 Shared",
  "delegation.capability": "能力档",
  "delegation.capabilityReadOnly": "只读（能力层不可写）",
  "delegation.capabilityWriter": "可写（实现角色）",
  "delegation.capabilityTools": "可用工具：{tools}",
  "delegation.capabilityWriterTools": "继承 Pi 默认工具集（含 bash / edit / write）",
  "delegation.preflight": "启动预检",
  "delegation.preflightChecking": "预检中…",
  "delegation.preflightRetry": "重新预检",
  "delegation.preflightError": "预检执行失败，请重试",
  "delegation.preflightBlocked": "预检未通过，请先修复标记为「不可用」的项",
  "delegation.preflightCheck.cwd": "工作目录",
  "delegation.preflightCheck.pi": "Pi 可执行文件",
  "delegation.preflightCheck.model": "目标模型",
  "delegation.preflightCheck.provider": "Provider 凭据",
  "delegation.preflightCheck.capability": "能力档",
  "delegation.preflightCheck.worktree": "Git 工作树",
  "delegation.preflightStatus.pass": "通过",
  "delegation.preflightStatus.warn": "注意",
  "delegation.preflightStatus.fail": "不可用",
  "delegation.preflightStatus.skip": "不适用",
  "delegation.cancel": "取消",
  "delegation.create": "创建委托",
  "delegation.creating": "创建中…",
  "delegation.created": "委托会话已创建",
  "delegation.failed": "创建委托失败",
  "delegation.loadFailed": "加载委托关系失败",
  "delegation.invalidTask": "请输入任务内容",
  "delegation.role.explore": "探索",
  "delegation.role.implement": "实现",
  "delegation.role.review": "审查",
  "delegation.role.consult": "咨询",
  "delegation.open": "委托",
  "delegation.child": "委托子会话",
  "delegation.returnToParent": "返回父会话",
  "delegation.handoffTitle": "返回父会话",
  "delegation.handoffTask": "任务",
  "delegation.handoffResult": "结果",
  "delegation.handoffChangedFiles": "变更文件（可选）",
  "delegation.handoffValidation": "验证（可选）",
  "delegation.handoffChildSession": "子会话 ID",
  "delegation.handoffResultPlaceholder": "总结子会话完成的结果",
  "delegation.handoffChangedFilesPlaceholder": "列出重要的变更文件",
  "delegation.handoffValidationPlaceholder": "列出运行过的验证或测试",
  "delegation.handoffSubmit": "返回结果",
  "delegation.handoffSubmitting": "返回中…",
  "delegation.handoffReturned": "结果已返回父会话",
  "delegation.handoffFailed": "返回父会话失败",
  "delegation.handoffResultRequired": "请输入结果",
  "pagination.label": "分页",
  ...
  "sessionRef.maxSelected": "最多选择 {count} 条",
...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  // ===== 用量统计（usage-stats） =====
  "usageStats.page.title": "用量",
  "usageStats.page.description": "这里同时展示 pi 的 openai-codex 账号配额，以及 pi-tracker 记录的本地 Token 活动。",
  "usageStats.quota.title": "ChatGPT 账户配额",
  "usageStats.quota.fiveHour": "五小时使用限额",
  "usageStats.quota.weekly": "每周使用限额",
  "usageStats.quota.plan": "套餐：{plan}",
  "usageStats.quota.planUnknown": "未知",
  "usageStats.quota.allowed": "当前可用",
  "usageStats.quota.unavailable": "当前不可用",
  "usageStats.quota.limitReached": "已触达限制",
  "usageStats.quota.remainingPercent": "剩余 {percentage}%",
  "usageStats.quota.resetsAt": "重置时间",
  "usageStats.quota.resetUnknown": "时间未知",
  "usageStats.quota.noWindows": "暂无可展示的配额窗口",
  "usageStats.quota.loading": "正在读取账户配额…",
  "usageStats.quota.notConfigured": "未配置 openai-codex OAuth 账号",
  "usageStats.quota.expired": "账号凭据已过期，等待 pi 更新后重试",
  "usageStats.quota.unauthorized": "账号认证失败，请先让 pi 更新登录凭据",
  "usageStats.quota.forbidden": "当前账号无权读取配额",
  "usageStats.quota.invalidResponse": "配额服务返回了暂不兼容的数据",
  "usageStats.quota.network": "暂时无法读取账户配额",
  "usageStats.quota.disabled": "当前环境暂不提供账户配额",
  "usageStats.quota.stale": "显示上一次成功读取的结果，可能已过期",
  "usageStats.quota.openUsageStats": "打开用量统计",
  "usageStats.page.source": "本地数据源：{path}",
  "usageStats.sections.current": "当前用量",
  "usageStats.sections.currentDesc": "按常用时间范围紧凑展示 Token、成本、轮次和会话活动。",
  "usageStats.sections.tokens": "Token 构成",
  "usageStats.sections.tokensDesc": "记录中的输入、输出和缓存 Token 相对占比。",
  "usageStats.sections.activity": "活动",
  "usageStats.period.today": "今日",
  "usageStats.period.week": "本周",
  "usageStats.period.month": "本月",
  "usageStats.period.total": "累计",
  "usageStats.metric.tokensShort": "Token",
  "usageStats.metric.turns": "{count} 轮",
  "usageStats.metric.sessions": "{count} 个会话",
  "usageStats.metric.activeDays": "{count} 天活跃",
  "usageStats.token.input": "输入 Token",
  "usageStats.token.output": "输出 Token",
  "usageStats.token.cacheRead": "缓存读取",
  "usageStats.token.cacheWrite": "缓存写入",
  ...
  "usageStats.notInstalled.installed": "已安装",
  ...
  "usageStats.notInstalled.copyFailed": "无法复制命令，请手动选中后复制。",
  "usageStats.notInstalled.installError": "安装失败：{message}",
  ...
  "usageStats.heatmap.mon": "一",
  "usageStats.heatmap.wed": "三",
  "usageStats.heatmap.fri": "五",
