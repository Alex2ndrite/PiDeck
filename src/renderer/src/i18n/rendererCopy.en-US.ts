...
export const enUS: Record<TranslationKey, string> = {
  ...
  "tabs.switchTo": "Switch to this session",
  ...
  "app.breakReminderTitleOne": "Time for a break — give your eyes a rest",
  "app.breakReminderTitleMany": "{hours} hours in — the code will wait, but your body won't",
  "app.breakReminderBodyOne": "You've been deep in the code for a while now. Stand up, grab some water, and look at something far away for a moment — your eyes and neck will love you for it. Who knows, the breakthrough might just show up after a 5-minute break.",
  "app.breakReminderBodyMany": "It's been {hours} hours. Your body is worth more than any code: get up, stretch, and breathe. Taking a break isn't slacking — it's recharging your brain.",
  "app.breakReminderMuteSession": "Mute for this session",
  "app.breakReminderDisableForever": "Never remind again",
  ...
  "config.skillHubInstallError": "Failed to install the skill. Try again later.",
  ...
  "config.nav.process": "Process Monitor",
  "config.process.title": "Processes & Memory",
  "config.process.refresh": "Refresh",
  "config.process.electronTotal": "Electron memory",
  "config.process.agentCount": "Running agents",
  "config.process.agentTotal": "Agents memory",
  "config.process.sampledAt": "Sampled at",
  "config.process.electronSection": "Electron processes",
  ...
  "config.process.type.main": "Main",
  "config.process.type.renderer": "Renderer",
  "config.process.type.gpu": "GPU",
  "config.process.type.utility": "Utility",
  "config.process.type.zygote": "Zygote",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "logs.clearSinceFilter": "Clear time filter",
  ...
  "usageStats.notInstalled.desc": "Usage stats relies on the pi-tracker extension to record token consumption of every conversation inside the pi process. This page activates automatically once installed.",
  "usageStats.notInstalled.installHint": "In a terminal run: pi install npm:pi-tracker, then restart the pi session",
  "usageStats.notInstalled.backfill": "For sessions before installation, run /analytics import inside pi to backfill history",
  ...
  "usageStats.models.title": "Model usage",
  ...
  "usageStats.projects.title": "Project usage",
  ...
  "settings.workBreakReminder": "Work duration break reminder",
  "settings.workBreakReminderDesc": "Timer starts at launch; reminds you to take a break every hour of continuous use",
