...
export const enUS: Record<TranslationKey, string> = {
  ...
  "delegation.unavailable": "Delegation is unavailable in preview mode",
  "delegation.title": "Delegate task",
  "delegation.task": "Task",
  "delegation.taskPlaceholder": "Describe the task for the child session",
  "delegation.role": "Role",
  "delegation.model": "Target model",
  "delegation.thinking": "Thinking / effort",
  "delegation.defaultThinking": "No override (use default)",
  "delegation.defaultModel": "Use parent session model",
  "delegation.modelsLoading": "Loading models…",
  "delegation.modelsEmpty": "No models available",
  "delegation.taskDeliveryFailed": "The child session was created, but the task was not delivered",
  "delegation.contextFresh": "Fresh context",
  "delegation.workspaceShared": "Shared workspace",
  "delegation.context": "Context mode",
  "delegation.contextFreshOption": "Fresh",
  "delegation.contextSelectedOption": "Selected messages",
  "delegation.contextForkOption": "Fork (native Pi fork)",
  "delegation.contextForkDescription": "Fork mode reuses Pi's native clone, keeps the parent history, and sends the task as the child's next message.",
  "delegation.selectedContextCount": "Selected context messages: {count}",
  "delegation.selectedContextLimit": "Up to {count} user/assistant messages",
  "delegation.selectedContextRequired": "Select at least one message for Selected mode",
  "delegation.selectContext": "Select messages",
  "delegation.selectContextTitle": "Select context messages",
  "delegation.selectContextConfirm": "Use selected messages",
  "delegation.constraints": "Constraints",
  "delegation.acceptanceCriteria": "Acceptance criteria",
  "delegation.relevantFiles": "Relevant files (optional)",
  "delegation.relevantFilesPlaceholder": "List file paths to focus on",
  "delegation.workspace": "Workspace mode",
  "delegation.workspaceSharedOption": "Shared workspace",
  "delegation.workspaceWorktreeOption": "Worktree (isolated workspace)",
  "delegation.worktreeChecking": "Checking Git worktree availability…",
  "delegation.worktreeUnavailable": "Git worktree is unavailable for this project; using Shared",
  "delegation.capability": "Capability profile",
  "delegation.capabilityReadOnly": "Read-only (write tools withheld)",
  "delegation.capabilityWriter": "Writer (implement role)",
  "delegation.capabilityTools": "Allowed tools: {tools}",
  "delegation.capabilityWriterTools": "Inherits Pi's default tool set (bash / edit / write)",
  "delegation.preflight": "Spawn preflight",
  "delegation.preflightChecking": "Checking…",
  "delegation.preflightRetry": "Re-check",
  "delegation.preflightError": "Preflight failed to run; please retry",
  "delegation.preflightBlocked": "Preflight did not pass; fix the items marked unavailable first",
  "delegation.preflightCheck.cwd": "Working directory",
  "delegation.preflightCheck.pi": "Pi executable",
  "delegation.preflightCheck.model": "Target model",
  "delegation.preflightCheck.provider": "Provider credentials",
  "delegation.preflightCheck.capability": "Capability profile",
  "delegation.preflightCheck.worktree": "Git worktree",
  "delegation.preflightStatus.pass": "Pass",
  "delegation.preflightStatus.warn": "Attention",
  "delegation.preflightStatus.fail": "Unavailable",
  "delegation.preflightStatus.skip": "Not applicable",
  "delegation.cancel": "Cancel",
  "delegation.create": "Create delegation",
  "delegation.creating": "Creating…",
  "delegation.created": "Delegated session created",
  "delegation.failed": "Failed to create delegation",
  "delegation.loadFailed": "Failed to load delegation relationships",
  "delegation.invalidTask": "Enter a task",
  "delegation.role.explore": "Explore",
  "delegation.role.implement": "Implement",
  "delegation.role.review": "Review",
  "delegation.role.consult": "Consult",
  "delegation.open": "Delegate",
  "delegation.child": "Delegated child session",
  "delegation.returnToParent": "Return to parent",
  "delegation.handoffTitle": "Return to parent",
  "delegation.handoffTask": "Task",
  "delegation.handoffResult": "Result",
  "delegation.handoffChangedFiles": "Changed files (optional)",
  "delegation.handoffValidation": "Validation (optional)",
  "delegation.handoffChildSession": "Child session ID",
  "delegation.handoffResultPlaceholder": "Summarize the child session result",
  "delegation.handoffChangedFilesPlaceholder": "List important changed files",
  "delegation.handoffValidationPlaceholder": "List validation or tests that ran",
  "delegation.handoffSubmit": "Return result",
  "delegation.handoffSubmitting": "Returning…",
  "delegation.handoffReturned": "Result returned to parent session",
  "delegation.handoffFailed": "Failed to return to parent session",
  "delegation.handoffResultRequired": "Enter a result",
  ...
  "sessionRef.maxSelected": "Select up to {count} messages",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "usageStats.page.title": "Usage",
  "usageStats.page.description": "View the ChatGPT quota for pi's openai-codex account alongside local token activity recorded by pi-tracker.",
  "usageStats.quota.title": "ChatGPT account quota",
  "usageStats.quota.fiveHour": "5-hour usage limit",
  "usageStats.quota.weekly": "Weekly usage limit",
  "usageStats.quota.plan": "Plan: {plan}",
  "usageStats.quota.planUnknown": "Unknown",
  "usageStats.quota.allowed": "Currently available",
  "usageStats.quota.unavailable": "Currently unavailable",
  "usageStats.quota.limitReached": "Limit reached",
  "usageStats.quota.remainingPercent": "{percentage}% remaining",
  "usageStats.quota.resetsAt": "Resets at",
  "usageStats.quota.resetUnknown": "Unknown",
  "usageStats.quota.noWindows": "No supported quota windows available",
  "usageStats.quota.loading": "Reading account quota…",
  "usageStats.quota.notConfigured": "No openai-codex OAuth account configured",
  "usageStats.quota.expired": "Credentials expired; retry after pi updates them",
  "usageStats.quota.unauthorized": "Account authentication failed; let pi refresh its credentials",
  "usageStats.quota.forbidden": "This account cannot read quota information",
  "usageStats.quota.invalidResponse": "Quota service returned an unsupported response",
  "usageStats.quota.network": "Account quota is temporarily unavailable",
  "usageStats.quota.disabled": "Account quota is unavailable in this environment",
  "usageStats.quota.stale": "Showing the last successful result; it may be out of date",
  "usageStats.quota.openUsageStats": "Open usage statistics",
  "usageStats.page.source": "Local data source: {path}",
  "usageStats.sections.current": "Current usage",
  "usageStats.sections.currentDesc": "A compact view of token, cost, turn, and session activity across common periods.",
  "usageStats.sections.tokens": "Token composition",
  "usageStats.sections.tokensDesc": "Relative shares of the recorded input, output, and cache tokens.",
  "usageStats.sections.activity": "Activity",
  "usageStats.period.today": "Today",
  "usageStats.period.week": "This week",
  "usageStats.period.month": "This month",
  "usageStats.period.total": "All time",
  "usageStats.metric.tokensShort": "tokens",
  "usageStats.metric.turns": "{count} turns",
  "usageStats.metric.sessions": "{count} sessions",
  "usageStats.metric.activeDays": "{count} active days",
  "usageStats.token.input": "Input tokens",
  "usageStats.token.output": "Output tokens",
  "usageStats.token.cacheRead": "Cache reads",
  "usageStats.token.cacheWrite": "Cache writes",
  "usageStats.token.percentage": "{name}: {percentage}%",
  "usageStats.retry": "Retry",
  ...
  "usageStats.notInstalled.installed": "Installed",
  ...
  "usageStats.notInstalled.copyFailed": "Could not copy the command. Select it and copy manually.",
  "usageStats.notInstalled.installError": "Installation failed: {message}",
  ...
  "usageStats.heatmap.mon": "Mon",
  "usageStats.heatmap.wed": "Wed",
  "usageStats.heatmap.fri": "Fri",
