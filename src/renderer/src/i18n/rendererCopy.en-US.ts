...
"config.emptyExtensions": "No installed extensions.",
  ...
  "settings.contentWidthPctDesc": "Messages and the composer share the same width, as a percentage of the chat pane. Higher = wider content with less margin; 100% fills the pane. Margins shrink automatically when split or on narrow windows.",
  "settings.contentWidthGap": "{pct}% margin on each side",
