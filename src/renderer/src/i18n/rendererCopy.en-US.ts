...
export const enUS: Record<TranslationKey, string> = {
  ...
  "app.breakReminderTitleOne": "One hour in — give your eyes a break",
  "app.breakReminderTitleMany": "{hours} hours in — the code will wait, but your body won't",
  "app.breakReminderBodyOne": "You've been working with PiDeck for a full hour. Stand up, grab some water, and look at something far away for a moment — your eyes and neck will love you for it. Who knows, the breakthrough might just show up after a 5-minute break.",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "settings.fontFamilyBaseLxgwWenKai": "LXGW WenKai",
