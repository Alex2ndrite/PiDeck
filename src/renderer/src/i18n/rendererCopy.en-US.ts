...
"config.emptyExtensions": "No installed extensions.",
  ...
  "usageStats.page.description": "A local view of token activity recorded by pi-tracker. These figures are usage statistics, not account quota or remaining credits.",
