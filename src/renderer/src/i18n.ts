...
const enUS: Record<TranslationKey, string> = {
  ...
  "mem.card.emptyAll": "No memories",
  "mem.card.loading": "Loading...",
  "mem.card.loadFailed": "Load failed",
  "mem.card.countItems": "{count} items",
  "mem.card.organize": "Organize",
  "mem.card.organizeTitle": "Let AI analyze and organize memories",
  "mem.card.refreshTitle": "Reload memory data",
  "mem.card.organizeDescription": "Organize memory store",
  "mem.card.organizePrompt": "Please organize my memory store. Read ~/.pi/agent/memory-store.json and analyze entries: remove duplicates, merge similar, delete temporary state.\n\nRules:\n1. Output analysis report only, do not invoke tools\n2. Do not ask questions, output the report directly\n3. User will operate in the UI based on your report",
  "mem.time.never": "Never",
  "mem.time.today": "Today",
  "mem.time.yesterday": "Yesterday",
  "mem.time.daysAgo": "{days} days ago",
